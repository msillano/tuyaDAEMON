...
- A DP can be proctively **PUSHED** by a device, especially to keep the UI up to date:
...
note: commands that are not implemented or not allowed by a device or a DP can have many bad effects:
